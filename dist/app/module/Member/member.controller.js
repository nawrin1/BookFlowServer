...
const createMember = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield member_service_1.MemberService.createMemberDB(req.body);
...
const updateSingleMember = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { memberId } = req.params;
    const result = yield member_service_1.MemberService.updateSingleMemberFromDB(memberId, req.body);
    (0, sendResponse_1.default)(res, {
        statusCode: 200,
        success: true,
...
const deleteSingleMember = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { memberId } = req.params;
    const result = yield member_service_1.MemberService.deleteSingleMemberFromDB(memberId);
    (0, sendResponse_1.default)(res, {
        statusCode: 200,
        success: true,
